...
using XCharts; // Import XChart namespace
...
public class mqttController : MonoBehaviour
{
    ...
    public TextMeshProUGUI timeText; // Reference to the TextMeshProUGUI for displaying the time



    //Forecast LineChart
    public LineChart forecastAppTempChart; // Forecast Line Chart
    ...
    //Current value Chart
    //LineChart
    public LineChart apparentTemperaturelineChart; // Reference to the LineChart component
    //RingChart
    public RingChart temperatureRingChart; // RingChart for temperature
    public RingChart humidityRingChart;    // RingChart for humidity
    public RingChart windSpeedRingChart;   // RingChart for wind speed
